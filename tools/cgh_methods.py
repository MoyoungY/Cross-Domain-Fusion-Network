...
from tools.algorithms import stochastic_gradient_descent, double_phase_amplitude_coding
...
class SGD(nn.Module):
    ...
    """
    def __init__(self, prop_dist, wavelength, feature_size, num_iters, roi_res, phase_path='./tmp', prop_model='ASM',
                 propagator=propagation_ASM, loss=nn.MSELoss(), lr=0.01, lr_s=0.003, s0=1, citl=False, camera_prop=None,
...
class DPAC(nn.Module):
    ...
    """
    def __init__(self, prop_dist, wavelength, feature_size, prop_model='ASM', propagator=propagation_ASM,
